...
export function AuthActionPanel() {
  const clerk = useClerk();     //after clicking the CONTINUE button, the user will be redirected to the sign-in page of Clerk for authentication. The fallbackRedirectUrl and forceRedirectUrl options ensure that after successful authentication, the user is redirected back to the specified AFTER_AUTH URL ("/" in this case).
